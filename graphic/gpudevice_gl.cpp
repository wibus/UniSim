...
void GpuDeviceGl::bindTexture(const GpuTextureResource& resource, const GpuProgramTextureBindPoint& bindPoint)
{
...
void GpuDeviceGl::bindTexture(const GpuImageResource& resource, const GpuProgramTextureBindPoint& unit)
{
    PILS_ASSERT(resource.handle().texId > 0, "Invalid texture index");
...
void GpuDeviceGl::bindImage(const GpuImageResource& resource, const GpuProgramImageBindPoint& unit)
{
